...
import com.example.mybarber.navigation.ROUTE_UPDATE_CLIENT
...
fun ViewClients(navController: NavHostController){
    ...
    Column (modifier = Modifier.fillMaxSize(),
        ...
        Column(
            ...
            Text(text = " YOUR RESERVATION HISTORY",
                fontSize = 30.sp,
...
fun ClientItem(firstname:String,lastname:String,time:String,
               date: String,id: String,navController: NavHostController,
    ...
    Column (modifier = Modifier.fillMaxWidth()){
                ...
                (containerColor = Color.Black))
        {
            Row {
                ...
                Column {
                    Image(painter = painterResource(id = R.drawable.reservationdetails),
